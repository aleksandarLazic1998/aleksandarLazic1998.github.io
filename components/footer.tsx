    ...
    <footer className="py-12 border-t border-gray-800 relative overflow-hidden">
      <div className="container relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              Software developer specialized in React and Node.js Ecosystem, building scalable and performant web
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-yellow-500/20 transition-colors duration-300"
                aria-label="Twitter"
              >
                <svg className="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-500">© {currentYear} Aleksandar Lazić. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
